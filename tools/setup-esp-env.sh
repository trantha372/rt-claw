...
echo ""
echo "To build rt-claw for ESP32-C3 QEMU:"
echo "  make esp32c3-qemu"
echo ""
echo "To build rt-claw for ESP32-S3 QEMU:"
echo "  make esp32s3-qemu"
echo ""
echo "To run on QEMU:"
echo "  tools/sim-run.sh -M esp32c3-qemu"
echo "  tools/sim-run.sh -M esp32s3-qemu"
